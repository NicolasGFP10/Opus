<%@ Page Title="" Language="C#" MasterPageFile="~/View/Site.Master" AutoEventWireup="true" CodeBehind="Configuracao.aspx.cs" Inherits="Opus.View.Telas.Usuario.Configuracao" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <center><button type="button" class="btn btn-danger" width="200px" data-bs-toggle="modal"  data-bs-target="#exampleModal">
        Desativar Conta
    </button></center>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-dark cor-roxa" data-bs-dismiss="modal" Width="200px">Fechar</button>
                    <center>
